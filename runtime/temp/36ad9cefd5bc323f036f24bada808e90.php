...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <label for="row[ShowStatus]-<?php echo $key; ?>"><input id="row[ShowStatus]-<?php echo $key; ?>" name="row[ShowStatus]" type="radio" value="<?php echo $key; ?>" <?php if(in_array(($key), is_array($row['ShowStatus'])?$row['ShowStatus']:explode(',',$row['ShowStatus']))): ?>checked<?php endif; ?> /> <?php echo $vo; ?></label>
            <?php endforeach; endif; else: echo "" ;endif; ?>
    ...
    <div class="form-group hidden">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-CreateByUserId" data-rule="required" class="form-control" name="row[CreateByUserId]" type="number" value="<?php echo $admin['id']; ?>">
        </div>
    </div>
    <div class="form-group hidden">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input checked="" id="c-IsHot_switch" name="row[IsHot_switch]" type="hidden" value="0"><label for="row[IsHot_switch]-switch"><input id="row[IsHot_switch]-switch" name="row[IsHot_switch]" type="checkbox" <?php if(in_array(($row['IsHot_switch']), explode(',',"1"))): ?>checked<?php endif; ?> value="<?php echo $row['IsHot_switch']; ?>"> </label>
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input checked="" id="c-IsZT_switch" name="row[IsZT_switch]" type="hidden" value="0"><label for="row[IsZT_switch]-switch"><input id="row[IsZT_switch]-switch" name="row[IsZT_switch]" type="checkbox" <?php if(in_array(($row['IsZT_switch']), explode(',',"1"))): ?>checked<?php endif; ?> value="1"> </label>
        </div>
    </div>
    <div class="form-group">
