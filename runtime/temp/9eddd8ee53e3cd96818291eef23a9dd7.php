...
<section id="webContainerMiddle" class="webContainerMiddle">
    ...
    <article id="webContentBody" class="webContentBody">
        <div class="detailHead">
            <span class="detailTitle"><?php echo empty($row['BiaoTi'])?$row['HouseName']:$row['BiaoTi']; ?></span>
        </div>
        <section>
            <div class="detailScrollImages fotorama" data-nav="thumbs">
                ...
                <img class="img-responsive" src="<?php echo $vo; ?>">
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </div>
            <div class="detailBaseInfo">
                <div class="priceDiv">
                    <span class="price_h1"><?php echo $row['FangJia']; ?></span><span class="priceUnit">元</span>
                </div>
                <div class="houseBaseInfoDiv">
                    <hr/>
                    <div class="baseInfoBox floatLeft">
                        <p class="infoBitFont"><?php echo $row['HuXing_Shi']; ?>室<?php echo $row['HuXing_Ting']; ?>厅<?php echo $row['HuXing_Wei']; ?>卫</p>
                        <p>户型</p>
                    </div>
                    <div class="baseInfoBox floatLeft boraderLeft boraderRight">
                        <p class="infoBitFont"><?php echo $row['JianZhuMianJi']; ?>平米</p>
                        <p>建筑面积</p>
                    </div>
                    <div class="baseInfoBox floatRight">
                        <p class="infoBitFont"></p>
                        <p></p>
                    </div>
                    <hr/>
                    <div class="baseInfoBox floatLeft">
                        <p class="infoBitFont"><?php echo $row->getChaoxiangTextAttr($row['ChaoXiang'],null); ?></p>
                        <p>朝向</p>
                    </div>
                    <div class="baseInfoBox floatLeft boraderLeft boraderRight">
                        <p class="infoBitFont">第<?php echo $row['LouCeng']; ?>层</p>
                        <p>楼层 (共<?php echo $row['CengGao']; ?>层)</p>
                    </div>
                    <div class="baseInfoBox floatRight">
                        <p class="infoBitFont"><?php echo $row->getZhuangxiuleixingTextAttr($row['ZhuangXiuLeiXing'],null); ?></p>
                        <p>装修</p>
                    </div>
                    <hr/>
                </div>
                <div class="trl-item2">
                    <div class="lab">小&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;区</div>
                    <div class="rcont"><?php echo $row['HouseName']; ?></div>
                </div>
                <div class="trl-item2" style="clear: both;padding-top: 15px;">
                    <div class="lab">区&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;域</div>
                    <div class="rcont"><?php echo $row['Adress_city']; ?></div>
                </div>
                <div class="trl-item2" style="margin-top: 50px;">
                    <a href="#" class="btn btn-danger btn-intention"
                       data-id="<?php echo $row['Id']; ?>"><i class="fa fa-pencil"></i> 预约看房</a>
                </div>

            </div>
        </section>
        <section class="alive-layout">
            <span class="sectionTitle">房源信息</span>
            <hr/>
            <div class="detailHouseSourceInfo">
                <div class="text-item clearfix">
                    <span class="lab">建筑年代</span>
                    <span class="rcont"><?php echo $row['JianZhuNianDai']; ?>年</span>
                </div>
                <div class="text-item clearfix">
                    <span class="lab">有无电梯</span>
                    <span class="rcont"><?php echo !empty($row['Elevator_switch']) && $row['Elevator_switch']==0?"无":"有"; ?> </span>
                </div>
                <div class="text-item clearfix">
                    <span class="lab">产权性质</span>
                    <span class="rcont"><?php echo $row->getChanquanTextAttr($row['ChanQuan'],null); ?></span>
                </div>
                <div class="text-item clearfix">
                    <span class="lab">住宅类别</span>
                    <span class="rcont"><?php echo $row->getZhuzhaileixingTextAttr($row['ZhuZhaiLeiXing'],null); ?></span>
                </div>
                <div class="text-item clearfix" style="clear: both">
                    <span class="lab">建筑结构</span>
                    <span class="rcont">平层</span>
                </div>
                <div class="text-item clearfix">
                    <span class="lab">建筑类别</span>
                    <span class="rcont">板楼</span>
                </div>
                <div class="text-item clearfix">
                    <span class="lab">挂牌时间</span>
                    <span class="rcont">2017-08-17</span>
                </div>
            </div>
        </section>
        <section class="alive-layout">
            <span class="sectionTitle">房源描述</span>
            <hr/>
            <div class="detailHouseSourceContent">
                <?php echo $row['content']; ?>
            </div>
        </section>
        <section class="alive-layout">
            <span class="sectionTitle">房源图片</span>
            <hr/>
            <div class="detailHouseSourceImages">
                <?php if(is_array($images) || $images instanceof \think\Collection || $images instanceof \think\Paginator): $i = 0; $__LIST__ = $images;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <img class="img-responsive img_margin" src="<?php echo $vo; ?>">
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </div>
        </section>
    </article>
