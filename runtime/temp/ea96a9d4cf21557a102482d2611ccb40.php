            ...
            <div class="tab-pane fade active in" id="one">
                <div class="widget-body no-padding">
                    <div id="toolbar" class="toolbar">
                        ...
                        <div class="dropdown btn-group <?php echo $auth->check('orderlog/multi')?'':'hide'; ?>">
                    ...
                    <table id="table" class="table table-striped table-bordered table-hover" 
                           data-operate-edit="<?php echo $auth->check('orderlog/edit'); ?>" 
                           data-operate-del="<?php echo $auth->check('orderlog/del'); ?>" 
                           width="100%">
                    </table>
                </div>
            </div>
