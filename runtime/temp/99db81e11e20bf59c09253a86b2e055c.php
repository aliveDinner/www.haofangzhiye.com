...
<script type="text/javascript">
    ...
    <div class="form-group">
        <label for="c-order_id" class="control-label col-xs-12 col-sm-2"><?php echo __('Order_id'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-order_id" data-rule="required" data-source="order/index" data-field="OrderCode"  class="form-control selectpage" name="row[order_id]" type="text" value="">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group hidden">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-admin_id"  class="form-control selectpage" name="row[admin_id]" type="text" value="<?php echo $admin['id']; ?>">
        </div>
    </div>
