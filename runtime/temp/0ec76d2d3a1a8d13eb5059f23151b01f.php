...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <textarea id="c-servicecontent" class="form-control summernote" rows="5" name="row[servicecontent]"  cols="50"><?php echo $row['servicecontent']; ?></textarea>
        </div>
    </div>
    <div class="form-group">
        <label for="c-GoldConsultant_switch" class="control-label col-xs-12 col-sm-2"><?php echo __('GoldConsultant_switch'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input checked="" id="c-GoldConsultant_switch" name="row[GoldConsultant_switch]" type="hidden" value="0"><label for="row[GoldConsultant_switch]-switch"><input id="row[GoldConsultant_switch]-switch" name="row[GoldConsultant_switch]" type="checkbox" <?php if(in_array(($row['GoldConsultant_switch']), explode(',',"1"))): ?>checked<?php endif; ?> value="1"></label>
        </div>
    </div>
    <div class="form-group">
