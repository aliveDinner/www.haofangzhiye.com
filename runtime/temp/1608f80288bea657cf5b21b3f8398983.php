...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <select  id="c-HouseSouceType" data-rule="required" class="form-control selectpicker" name="row[HouseSouceType]" readonly>
    ...
    <div class="form-group hidden">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <label for="row[ShowStatus]-<?php echo $key; ?>"><input id="row[ShowStatus]-<?php echo $key; ?>" name="row[ShowStatus]" type="radio" value="<?php echo $key; ?>" <?php if(in_array(($key), explode(',',"0"))): ?>checked<?php endif; ?> /> <?php echo $vo; ?></label>
            <?php endforeach; endif; else: echo "" ;endif; ?>
