...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-cost" data-rule="required" class="form-control" name="row[cost]" type="number" value="<?php echo $row['cost']; ?>">
        </div>
    </div>
    <div class="form-group">
        <label for="c-profit" class="control-label col-xs-12 col-sm-2"><?php echo __('Profit'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-profit" class="form-control" name="row[profit]" type="number" value="<?php echo $row['profit']; ?>">
        </div>
    </div>
    <div class="form-group">
