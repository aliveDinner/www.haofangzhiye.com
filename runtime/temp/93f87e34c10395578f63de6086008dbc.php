            ...
            <div class="tab-pane fade active in" id="one">
                <div class="widget-body no-padding">
                    <div id="toolbar" class="toolbar">
                        ...
                        <div class="dropdown btn-group <?php echo $auth->check('village/multi')?'':'hide'; ?>">
                    ...
                    <table id="table" class="table table-striped table-bordered table-hover" 
                           data-operate-edit="<?php echo $auth->check('village/edit'); ?>" 
                           data-operate-del="<?php echo $auth->check('village/del'); ?>" 
                           width="100%">
                    </table>
                </div>
            </div>
