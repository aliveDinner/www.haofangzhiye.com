								...
								<div class="layui-inline">
									...
									<div class="layui-input-inline" style="width: 130px;">
										<select name="room" lay-search >
											...
											<option value="<?php echo $key; ?>" <?php if(\think\Request::instance()->get('room') == $key): ?>selected<?php endif; ?> ><?php echo $item; ?></option>
											<?php endforeach; endif; else: echo "" ;endif; ?>
										</select>
									</div>
									<div class="layui-input-inline" style="width: 130px;">
										<select name="hall" lay-search >
											...
											<option value="<?php echo $key; ?>" <?php if(\think\Request::instance()->get('hall') == $key): ?>selected<?php endif; ?> ><?php echo $item; ?></option>
											<?php endforeach; endif; else: echo "" ;endif; ?>
										</select>
									</div>
									...
									<div class="layui-input-inline" style="width: 130px;">
										<select name="toilet" lay-search >
											...
											<option value="<?php echo $key; ?>" <?php if(\think\Request::instance()->get('toilet') == $key): ?>selected<?php endif; ?> ><?php echo $item; ?></option>
											<?php endforeach; endif; else: echo "" ;endif; ?>
										</select>
									</div>
									...
									<div class="layui-input-inline" style="width: 130px;">
										<select name="face" lay-search >
											...
											<option value="<?php echo $key; ?>" <?php if(\think\Request::instance()->get('face') == $key): ?>selected<?php endif; ?> ><?php echo $item; ?></option>
											<?php endforeach; endif; else: echo "" ;endif; ?>
										</select>
									</div>
								</div>
				...
				<div class="alive-flex alive-Level" style="width: 100%;min-height:300px;overflow: hidden;">
					<div class="alive-layout">
						...
						<div class="alive-body alive-upLevel">
							...
							<?php if(is_array($houseList) || $houseList instanceof \think\Collection || $houseList instanceof \think\Paginator): $i = 0; $__LIST__ = $houseList;if( count($__LIST__)==0 ) : echo "<p style='display:inline-block;font-size: 16px;width:100%;color:#ff5722;text-align: center;'>没有符合你要的房源</p>" ;else: foreach($__LIST__ as $key=>$model): $mod = ($i % 2 );++$i;?>
								...
								<div class="alive-body alive-upLevel">
									<div class="alive-level" style="width:100%;min-height:200px;position: relative;overflow: hidden;">
										...
										<div style="width: 240px;">
											<a href="#" class="houseTitle_a" data-id="<?php echo $model['Id']; ?>"><img class="imgBox" alt="" title="" src="<?php echo explode(',',$model['Images'])[0]; ?>" style="border-radius: 2px;"></a>
										</div>
										<div style="flex: 1;">
											<p style="line-height:3em;"><a href="#" class="houseTitle_a" data-id="<?php echo $model['Id']; ?>"> <strong><span style="font-family:微软雅黑;color:#FE8300;font-size:20px;"><?php echo empty($model['BiaoTi'])?$model['HouseName']:$model['BiaoTi']; ?></span></strong></a></p>
											<p style="line-height:3em;"><span style="font-family:微软雅黑;color:#333333;font-size:17px;"><?php echo $model->getZhuangxiuleixingTextAttr($model['ZhuangXiuLeiXing'],null); ?> &nbsp; <?php echo $model['HuXing_Shi']; ?>室<?php echo $model['HuXing_Ting']; ?>厅 &nbsp; <?php echo $model['JianZhuNianDai']; ?>年建造</span></p>
											<p style="line-height:3em;"><span style="font-family:微软雅黑;font-size:18px;color:#333333;"><span style="font-size:14px;color:#666666;"><?php echo $model['Adress_city']; ?></span></span></p>
											...
											<p style="clear:both;">
												<a href="#" class="btn btn-danger btn-intention" data-id="<?php echo $model['Id']; ?>"><i class="fa fa-pencil"></i> 预约看房</a>
											</p>
										</div>
										<div style="width: 240px;">
											<p style="text-align:center;"><span style="font-family:微软雅黑;font-size:22px;color:#333333;"><br></span></p>
											<p style="text-align:center;"><span style="font-family:微软雅黑;font-size:22px;color:#333333;"><br></span></p>
											<p style="text-align:center;"><span style="font-family:微软雅黑;font-size:18px;color:#333333;"><?php echo $model['MianJi']; ?>平米</span></p>
										</div>
										<div style="width: 200px;">
											...
											<p style="line-height:2em;text-align:left;"><strong><span style="font-family:微软雅黑;color:#FE8300;font-size:26px;"><?php echo $model['FangJia']/10000; ?>万</span></strong></p>
											<p style="line-height:2em;text-align:left;"><span style="font-family:微软雅黑;font-size:18px;color:#333333;"><span style="font-size:13px;color:#666666;"><?php echo $model['DanJia']; ?>元/平米</span></span></p>
											<p><br></p>
										</div>
