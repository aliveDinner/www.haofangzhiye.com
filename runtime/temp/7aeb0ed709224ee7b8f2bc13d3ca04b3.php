...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-intention_id" data-rule="required" data-source="intention/index" data-field="Id"  class="form-control selectpage" name="row[intention_id]" type="text" value="">
        </div>
    </div>
    <div class="form-group">
