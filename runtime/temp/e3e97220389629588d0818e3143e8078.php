...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class='control-relative'><input id="c-house_city" class="form-control" data-toggle="city-picker" name="row[house_city]" type="text" value="" ></div>
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group hidden">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-house_id" class="form-control" name="row[house_id]" type="text" value="" readonly>
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-housename" class="form-control" name="row[housename]" type="text" value="" >
        </div>
    </div>
    <div class="form-group">
