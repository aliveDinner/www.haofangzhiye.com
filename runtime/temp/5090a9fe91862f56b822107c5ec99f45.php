...
<section id="webContainerMiddle" class="webContainerMiddle">
    ...
    <article id="webContentBody" class="webContentBody">
        ...
        <section class="alive-layout">
            ...
            <article class="alive-header" style="height: 100px;">
                <div class="alive-title" style="width: 100%;">
                    <div class="title">楼市政策</div>
                </div>
            </article>

            <article class="alive-body">
                <div id="imgNews" class="alive-flex outer">
        ...
        <section class="alive-layout newsLeftList">
            ...
            <article class="alive-header" style="height: 100px;">
                <div class="alive-title" style="width: 100%;">
                    <div class="title">购房资讯</div>
                </div>
            </article>

            <article class="alive-body " style="margin-top: -40px">
                <div  class="alive-line alive-outer" style="margin-left: 0px;margin-right: 0px">
                    <table id="table2" class="table table-no-bordered" width="100%">
        ...
        <section class="alive-layout questionRightList">
            ...
            <article class="alive-body" style="margin-top: -40px">
                <div  class="alive-line alive-outer" style="margin-left: 0px;margin-right: 0px">
                    <table id="table3" class="table table-no-bordered" width="100%">
