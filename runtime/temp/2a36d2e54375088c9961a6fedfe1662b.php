    ...
    <section id="banner-body" class="flex" style="display: block;min-height: 300px;">
        ...
        <article id="bannerMiddleTable" class="middleTable">
            ...
            <section class="centerTable flex-middle-center">
                ...
                <div id="webBanner" style="width: 1200px; overflow: hidden; height: 300px;">
                    <img src="../../../../assets/img/contact_baner.jpg" style="width: 100%;"/>
                </div>
...
<section id="webContainerMiddle" class="webContainerMiddle" style="margin-top: 20px">
    ...
    <article id="webContentBody" class="webContentBody">
        <div id="ContactTabs" class="ContactTabs">
            <ul>
                <li>企业介绍</li>
                <li>联系我们</li>
                <li>金牌顾问</li>
            ...
            <div >
                <div class="contactInfo">
                    <table>
                        <tbody>
                        <tr class="lxr">
                            <td colspan="4" class="c_us"><?php echo $row['companyname']; ?></td>
                        </tr>
                        <tr>
                            <td class="tdLab">联系人：</td>
                            <td colspan="3" class="tdText"><?php echo $row['contact']; ?></td>
                        </tr>
                        <tr>
                            <td class="tdLab">联系电话：</td>
                            <td class="tdText"><?php echo $row['contactphone']; ?></td>
                            <td class="tdLab">移动电话：</td>
                            <td class="tdText"><?php echo $row['contactphone1']; ?></td>
                        </tr>
                        <tr>
                            <td class="tdLab">QQ：</td>
                            <td class="tdText"><?php echo $row['qq']; ?></td>
                            <td class="tdLab">Email：</td>
                            <td class="tdText"><?php echo $row['email']; ?></td>
                        </tr>
                        <tr>
                            <td class="tdLab">微信：</td>
                            <td colspan="3"><?php echo $row['wechat']; ?></td>
                        </tr>
                        <tr>
                            <td class="tdLab">公司地址：</td>
                            <td colspan="3"><?php echo $row['adress']; ?></td>
                        </tr>

                        </tbody>
                    </table>
                    <img src="../../../../assets/img/contact_map.jpg" height="317" width="840"/>
                </div>
...
<script id="itemtpl" type="text/html">
    ...
    <div class="col-sm-4 col-md-3">
        <div class="thumbnail example">
            <img src="<%=item.avatar%>" class="img-responsive" alt="<%=item.nickname%>">
            <div class="caption">
                <p><span><%=item.nickname%></span> <span class="floatRight"><a href="tencent://message/?uin=<%=item.qq%>&Site=在线QQ&Menu=yes"> <img border="0" src="http://wpa.qq.com/pa?p=2:351218741:41"  ></a>  </span></p>
                <hr/>
                <p class="text-muted"><span><%=item.mobile%></span></p>
                <p class="text-muted">服务口号:<span><%=#item.servicecontent%></span></p>
            </div>
        </div>
    </div>
</script>
