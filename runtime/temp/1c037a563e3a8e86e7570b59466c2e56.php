...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-house_id" data-rule="required" data-source="house/index" data-field="HouseName" class="form-control selectpage" name="row[house_id]" type="text" value="">
        </div>
    </div>
    <div class="form-group">
        <label for="c-user_id" class="control-label col-xs-12 col-sm-2"><?php echo __('User_name'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-user_id"  data-source="user/index" data-field="nickname" class="form-control selectpage" name="row[user_id]" type="text" value="">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-admin_id" data-rule="required" data-source="admin/index" data-field="nickname" class="form-control selectpage" name="row[admin_id]" type="text" value="<?php echo $admin['id']; ?>">
        </div>
    </div>
    <div class="form-group">
        <label for="c-admin_name" class="control-label col-xs-12 col-sm-2"><?php echo __('Admin_name'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-admin_name" data-rule="required" class="form-control" name="row[admin_name]" type="text" value="<?php echo $admin['nickname']; ?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-cost" data-rule="required" class="form-control" name="row[cost]" type="number" value="0">
        </div>
    </div>
    <div class="form-group">
        <label for="c-profit" class="control-label col-xs-12 col-sm-2"><?php echo __('Profit'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-profit" class="form-control" name="row[profit]" type="number">
        </div>
    </div>
    <div class="form-group">
