            ...
            foreach ($columnList as $k => $v)
            {
                ...
                if ($v['COLUMN_KEY'] != 'PRI' && !in_array($field, $this->reservedField))
                {
                    ...
                    else if ($inputType == 'switch')
                    {
                        ...
                        $formAddElement .= sprintf(Form::label("{$attrArr['id']}", "%s"), Form::checkbox($fieldName, $yes, $defaultValue === $yes, $attrArr));
                        $formEditElement .= sprintf(Form::label("{$attrArr['id']}", "%s"), Form::checkbox($fieldName, $yes, 0, $attrArr));
