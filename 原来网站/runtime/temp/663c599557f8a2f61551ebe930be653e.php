    ...
    <article id="webContentBody" class="webContentBody">
        ...
        <section class="alive-layout">
            ...
            <article class="alive-header" style="overflow: hidden;position: absolute;left: 0;right: 0;z-index: -1;">
                <img data-url="/static/uploads/theme/better/theme-service-contact-bg.jpg" style="height: 300px;width: 100%;">
            </article>
        ...
        <section class="alive-layout">
            ...
            <article class="alive-header" style="height: 100px;">
                <div class="alive-title" style="width: 100%;">
                    ...
                    <div class="extra"><p style="cursor:pointer;">更多家装</p></div>
                </div>
            </article>

            <article class="alive-body">
                <div id="betterHot" class="alive-flex alive-upLevel" style="width:100%;min-height:600px;position: relative;overflow: hidden;">
                    <div class="alive-flex" style="position: relative;">
                        ...
                        <div class="item alive-item-outer" style="width: 350px;height: 350px;">
                            ...
                            <div class="alive-upLevel itemTitle" style="height: 140px;">
                                <div class="key">
                                    <p><a class="alive-active"><span>家装介绍...</span></a></p>
                                </div>
                                <div class="detail">
                                    <p>硬装 软件 ...</p>
                                </div>
