<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:80:"/usr/share/nginx/haofangzhiye/public/../application/manage/view/house/index.html";i:1503420557;s:88:"/usr/share/nginx/haofangzhiye/public/../application/common/view/layouts/manage-main.html";i:1503420551;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
...
<script>
    var url = {
        createHouseUrl:"<?php echo url('/house/create'); ?>",
        createHandHouseUrl:"<?php echo url('/hand_house/create'); ?>",
        updateUrl:"<?php echo url('/house/update'); ?>",
        viewUrl:"<?php echo url('/house/view'); ?>",
        deleteUrl:"<?php echo url('/house/delete'); ?>"
    };
    $(function() {
        //分页
        Site.loadPage();
