define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    index_url: 'housemanage/myhouse/index',
                    add_url: 'housemanage/myhouse/add',
                    edit_url: 'housemanage/myhouse/edit',
                    del_url: 'housemanage/myhouse/del',
                    multi_url: 'housemanage/myhouse/multi',
                    table: 'house',
                }
            });
