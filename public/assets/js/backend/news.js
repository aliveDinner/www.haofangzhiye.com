define(['jquery', 'bootstrap', 'backend', 'table', 'form'], function ($, undefined, Backend, Table, Form) {
    ...
    var Controller = {
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'newstype_text', title: __('Newstype'), operate:false},
                        {field: 'titleimage', title: __('Titleimage'), formatter: Table.api.formatter.image},
                        {field: 'tag', title: __('Tag')},
                        {field: 'createtime', title: __('Createtime'), formatter: Table.api.formatter.datetime},
                        {field: 'isnew_switch', title: __('Isnew_switch'),formatter: Controller.api.formatter.isnew_switch},
        ...
        api: {
            formatter: {
                isnew_switch: function (value, row, index) {
                    return "<a href='javascript:;' class='btn btn-" + (value ? "info" : "default") + " btn-xs btn-change' data-id='"
                        + row.id + "' data-params='isnew=" + (value ? 0 : 1) + "'>" + (value ? __('Yes') : __('No')) + "</a>";
                }
            },
            bindevent: function () {
