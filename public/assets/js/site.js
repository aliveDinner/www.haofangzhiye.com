...
Site.config = {
    ...
    imageError: '/assets/img/not-capture.png',
    layuiBase: '/static/js/',
...
Site.imgLoading = function (ele) {
    ...
    var img = '<div style="display: flex;width: ' + _width + ';height: ' + _height + ';"><div style="margin: auto;"><img src="/assets/img/loading-2.gif"></div></div>';
    $this.html(img);
    ...
    var _src = $this.attr('lay-src'),
        ...
        _error = $this.attr('lay-error') || '/assets/img/lockscreenbg.png';
    var attr = '';
    if (_class !== '') {
        attr += ' class="' + _class + '"';
    }
...
Site.initBanner = function (data, options) {
    ...
    var $default = {
        ...
        interval: 6000,//播放间隔
        barColor: false,//背景色
        loading: '/assets/img/loading.png',//设置懒加载等待图
    };
